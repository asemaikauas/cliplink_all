...
async def analyze_transcript_with_gemini(transcript_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    prompt = f"""
     ...
     INSTRUCTIONS:
     Analyze the transcript for viral moments, hooks, and engaging content, create 5 short video segments (40 seconds to 2 minutes each) depending 
        ...
        if 'candidates' in gemini_response and len(gemini_response['candidates']) > 0:
            ...
            if 'content' in candidate and 'parts' in candidate['content']:
                ...
                try:
                    ...
                    print(f"\n🎯 Gemini found {len(viral_analysis.get('viral_segments', []))} viral segments")
                    ...
                    if 'viral_segments' in viral_analysis:
                        ...
                        print(f"\n📋 OPTIMIZED JSON (title, start, end, duration only):")
                        print("=" * 60)
                        print(json.dumps(viral_analysis, ensure_ascii=False, indent=2))
                        print("=" * 60)
                        print(f"🚀 OPTIMIZATION: Removed subtitle extraction - subtitles generated by Groq instead")
                    else:
                        print(f"⚠️ No viral segments found in Gemini response")
